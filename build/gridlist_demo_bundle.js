...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SortableListItem = __webpack_require__(166);
	
	var _SortableListItem2 = _interopRequireDefault(_SortableListItem);
	
	var _SortableGridItem = __webpack_require__(168);
	
	var _SortableGridItem2 = _interopRequireDefault(_SortableGridItem);
	
	var _StateView = __webpack_require__(169);
	
	var _StateView2 = _interopRequireDefault(_StateView);
	...
	var App = _react2.default.createClass({
	  ...
	  getInitialState: function getInitialState() {
	    return {
	      items: ["Gold", "Crimson", "Hotpink", "Blueviolet", "Cornflowerblue", "Skyblue", "Lightblue", "Aquamarine", "Burlywood"],
	      draggingIndex: null
	    };
	  },
	  ...
	  render: function render() {
	    ...
	    var listItems = this.state.items.map(function (item, i) {
	      return _react2.default.createElement(_SortableListItem2.default, {
	        key: i,
	    ...
	    var gridItems = this.state.items.map(function (item, i) {
	      return _react2.default.createElement(_SortableGridItem2.default, { key: i,
	        updateState: this.updateState,
	        items: this.state.items,
	        draggingIndex: this.state.draggingIndex,
	        sortId: i,
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(_StateView2.default, { items: this.state.items, dragging: this.state.draggingIndex })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = (0, _SortableComposition.SortableComposition)(ListItem);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GridItem = _react2.default.createClass({
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      'div',
	      _extends({}, this.props, { className: 'grid-item' }),
	      _react2.default.createElement(
	        'span',
	        null,
	        this.props.item
	...
	exports.default = (0, _SortableComposition.SortableComposition)(GridItem);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StateView = _react2.default.createClass({
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'pre',
	        null,
	        JSON.stringify(this.props.items, 0, 2)
	      ),
	      _react2.default.createElement(
	        'pre',
	        null,
	        JSON.stringify(this.props.dragging, 0, 2)
	      )
	    );
	  }
	});
