...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SortableListItem = __webpack_require__(159);
	
	var _SortableListItem2 = _interopRequireDefault(_SortableListItem);
	
	var _SortableGridItem = __webpack_require__(161);
	
	var _SortableGridItem2 = _interopRequireDefault(_SortableGridItem);
	
	var _StateView = __webpack_require__(162);
	...
	var App = _react2.default.createClass({
	  ...
	  sort: function sort(items, dragging) {
	  ...
	  render: function render() {
	    ...
	    var gridItems = this.state.data.items.map(function (item, i) {
	      return _react2.default.createElement(_SortableGridItem2.default, { style: { background: item }, key: i,
	        sort: this.sort,
	        data: this.state.data,
	        sortId: i,
	        item: item });
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(_StateView2.default, { data: this.state.data })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SortableGridItem = _react2.default.createClass({
	  displayName: 'SortableGridItem',
	
	  render: function render() {
	    return _react2.default.createElement(
	      'div',
	      _extends({}, this.props, { className: this.props.isDragging() ? "dragging" : "" }),
	      _react2.default.createElement(
	        'span',
	        null,
	        this.props.item
	  ...
	  placement: function placement(x, y, over) {
	    var width = over.offsetWidth / 2;
	    return x > width;
	  }
	});
	
	exports.default = (0, _SortableComposition2.default)(SortableGridItem);
